...
#include "spider_msgs/srv/detail/set_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const spider_msgs::srv::SetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spider_msgs::srv::SetPose_Request & ros_message)
{
  // Member: target_pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = spider_msgs::srv::SetPose_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spider_msgs::srv::SetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<spider_msgs::srv::SetPose_Request *>(
    untyped_ros_message);
...
{
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spider_msgs, srv, SetPose_Request)() {
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_spider_msgs
cdr_serialize(
  const spider_msgs::srv::SetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spider_msgs::srv::SetPose_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spider_msgs::srv::SetPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const spider_msgs::srv::SetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<spider_msgs::srv::SetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spider_msgs, srv, SetPose_Response)() {
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Response__handle;
}
...
// functions for spider_msgs::srv::SetPose_Request already declared above

// functions for spider_msgs::srv::SetPose_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_spider_msgs
cdr_serialize(
  const spider_msgs::srv::SetPose_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  spider_msgs::srv::SetPose_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        spider_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        spider_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = spider_msgs::srv::SetPose_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        spider_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        spider_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const spider_msgs::srv::SetPose_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<spider_msgs::srv::SetPose_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spider_msgs, srv, SetPose_Event)() {
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose_Event__handle;
}
...
static const rosidl_service_type_support_t _SetPose__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<spider_msgs::srv::SetPose_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<spider_msgs::srv::SetPose_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<spider_msgs::srv::SetPose_Event>(),
...
{
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, spider_msgs, srv, SetPose)() {
  return &spider_msgs::srv::typesupport_fastrtps_cpp::_SetPose__handle;
}
