...
#include "spider_msgs/msg/detail/leg_positions__rosidl_typesupport_fastrtps_c.h"
...
#include "spider_msgs/msg/detail/leg_position__functions.h"  // legs
...
using _LegPositions__ros_msg_type = spider_msgs__msg__LegPositions;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 4;
    auto array_ptr = ros_message->legs;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_spider_msgs__msg__LegPosition(
        &array_ptr[i], cdr);
    }
  }
  ...
  spider_msgs__msg__LegPositions * ros_message)
{
  // Field name: legs
  {
    ...
    auto array_ptr = ros_message->legs;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_spider_msgs__msg__LegPosition(cdr, &array_ptr[i]);
    }
  }
...
size_t get_serialized_size_spider_msgs__msg__LegPositions(
  ...
  size_t current_alignment)
{
  const _LegPositions__ros_msg_type * ros_message = static_cast<const _LegPositions__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  // Field name: legs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_spider_msgs__msg__LegPosition(
  ...
  size_t current_alignment)
{
  ...
  // Field name: legs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_spider_msgs__msg__LegPosition(
  ...
  if (is_plain) {
    ...
    using DataType = spider_msgs__msg__LegPositions;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: legs
  {
    ...
    auto array_ptr = ros_message->legs;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_spider_msgs__msg__LegPosition(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: legs
  {
    ...
    auto array_ptr = ros_message->legs;
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_spider_msgs__msg__LegPosition(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: legs
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_spider_msgs__msg__LegPosition(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const spider_msgs__msg__LegPositions * ros_message = static_cast<const spider_msgs__msg__LegPositions *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_spider_msgs__msg__LegPositions(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  spider_msgs__msg__LegPositions * ros_message = static_cast<spider_msgs__msg__LegPositions *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_spider_msgs__msg__LegPositions(cdr, ros_message);
}

static uint32_t _LegPositions__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_spider_msgs__msg__LegPositions(
...
static size_t _LegPositions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_spider_msgs__msg__LegPositions(
...
static message_type_support_callbacks_t __callbacks_LegPositions = {
  "spider_msgs::msg",
  "LegPositions",
...
static rosidl_message_type_support_t _LegPositions__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LegPositions,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spider_msgs, msg, LegPositions)() {
  return &_LegPositions__type_support;
}
