...
static char spider_msgs__msg__LegPositions__FIELD_NAME__legs[] = "legs";
static char spider_msgs__msg__LegPositions__FIELD_NAME__header[] = "header";

static rosidl_runtime_c__type_description__Field spider_msgs__msg__LegPositions__FIELDS[] = {
  {
    {spider_msgs__msg__LegPositions__FIELD_NAME__legs, 4, 4},
    {
  ...
  {
    {spider_msgs__msg__LegPositions__FIELD_NAME__header, 6, 6},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription spider_msgs__msg__LegPositions__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {spider_msgs__msg__LegPositions__FIELDS, 2, 2},
    },
    {spider_msgs__msg__LegPositions__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "LegPosition[4] legs              # leg[0] = front-right, leg[1] = front-left, \n"
...
spider_msgs__msg__LegPositions__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *spider_msgs__msg__LegPositions__get_individual_type_description_source(NULL),
