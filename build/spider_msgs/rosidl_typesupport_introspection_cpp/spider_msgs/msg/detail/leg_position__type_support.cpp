...
{
  new (message_memory) spider_msgs::msg::LegPosition(_init);
}

void LegPosition_fini_function(void * message_memory)
{
  auto typed_message = static_cast<spider_msgs::msg::LegPosition *>(message_memory);
  typed_message->~LegPosition();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember LegPosition_message_member_array[2] = {
  {
    "position",  // name
    ...
    offsetof(spider_msgs::msg::LegPosition, position),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(spider_msgs::msg::LegPosition, movement_speed),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LegPosition_message_members = {
  ...
  2,  // number of fields
  sizeof(spider_msgs::msg::LegPosition),
...
{
  return &::spider_msgs::msg::rosidl_typesupport_introspection_cpp::LegPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, spider_msgs, msg, LegPosition)() {
  return &::spider_msgs::msg::rosidl_typesupport_introspection_cpp::LegPosition_message_type_support_handle;
}
