...
class SetPose_Request(metaclass=Metaclass_SetPose_Request):
    ...
    _fields_and_field_types = {
        'target_pose': 'spider_msgs/LegPositions',
    ...
    def __init__(self, **kwargs):
        ...
        from spider_msgs.msg import LegPositions
        self.target_pose = kwargs.get('target_pose', LegPositions())
        self.movement_speed = kwargs.get('movement_speed', float())
    ...
    def target_pose(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'target_pose' field must be a sub message of type 'LegPositions'"
        self._target_pose = value

    @builtins.property
    def movement_speed(self):
        """Message field 'movement_speed'."""
    ...
    def movement_speed(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'movement_speed' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'movement_speed' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
...
class SetPose_Event(metaclass=Metaclass_SetPose_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<spider_msgs/SetPose_Request, 1>',
        'response': 'sequence<spider_msgs/SetPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['spider_msgs', 'srv'], 'SetPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['spider_msgs', 'srv'], 'SetPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from spider_msgs.srv import SetPose_Request
    ...
    def response(self, value):
        if self._check_fields:
            from spider_msgs.srv import SetPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_SetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from spider_msgs.srv import _set_pose
...
class SetPose(metaclass=Metaclass_SetPose):
    from spider_msgs.srv._set_pose import SetPose_Request as Request
    from spider_msgs.srv._set_pose import SetPose_Response as Response
    from spider_msgs.srv._set_pose import SetPose_Event as Event
